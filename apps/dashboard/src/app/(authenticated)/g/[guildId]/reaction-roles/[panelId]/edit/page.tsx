...
interface EditReactionRolesPageProps {
  readonly params: Promise<{ readonly guildId: string; readonly panelId: string }>;
}

export default async function EditReactionRolesPage({
  params,
}: EditReactionRolesPageProps): Promise<React.JSX.Element> {
  ...
  return (
    <>
      <Topbar
        ...
        avatarUrl={avatarUrl}
        title="Edit reaction-roles panel"
