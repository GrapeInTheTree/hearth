...
interface EditSelfRolesPageProps {
  readonly params: Promise<{ readonly guildId: string; readonly panelId: string }>;
}

export default async function EditSelfRolesPage({
  params,
}: EditSelfRolesPageProps): Promise<React.JSX.Element> {
