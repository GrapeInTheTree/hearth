...
export const en = {
  ...
  overview: {
    ...
    counts: {
      ...
      reactionRolesPanels: 'Reaction-roles panels',
      reactionRolesActiveHolders: 'Reaction-role users',
    },
    sections: {
    ...
    activity: {
      ...
      reactionRolesGranted: 'Reaction-role granted',
      reactionRolesRevoked: 'Reaction-role revoked',
      reactionRolesNoop: 'Reaction-role op rejected by Discord',
    },
    quickActions: {
