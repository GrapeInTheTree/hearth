...
// PGlite-backed in-memory Postgres. Replays every migration in order so
// the XWatcher tables exist alongside the rest of the schema. Same
// approach as the other domain cores' test helpers.
